...
int main(){
	...
	printArray(arr, length);  // Given array is : 12 11 13 5 6 7 
...
// Merge Sort with Singly Linked List
// --------------------------------------------
// --------------------------------------------

#ifdef MERGE_SORT_SINGLY_LINKED_LIST
...
#endif // MERGE_SORT_SINGLY_LINKED_LIST
...
#ifdef MERGE_SORT_DOUBLY_LINKED_LIST
...
#endif // MERGE_SORT_DOUBLY_LINKED_LIST
